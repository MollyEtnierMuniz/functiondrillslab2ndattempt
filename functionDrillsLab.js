...
//CODE HERE this is a declaritive function followed by an arrow function
// function printName(name){
//   console.log (name)
// }
// printName ('Molly')

// let printName2 = (name2) =>{
//   console.log (name2)
// }
// printName2('Molly Etnier')
////////////////// PROBLEM 4 ////////////////////
/*
...
*/
//CODE HERE this is the decrative function form, followed by arrow form
// function greeting(name) {
//   console.log (`Hello, ${name}, you look terrific today.`)
// }

// greeting('Molly')

// let greeting2 = (name2) => {
//   console.log (`Hello ${name2}. Extra credit for you!`)
// }
// greeting2('Molly')
...
//   Create a variable outside the function called 'sum' 
//   and set it equal to add invoked (called), passing in 2 arguments.
// */
...
// */
// //CODE HERE  I put a function in there to convert a number to a string, but it's unneeded
// console.log ('   ')
// console.log ('   ')
...
// }
// nameGreeting = console.log (nameCheck('Antonio'))
...
//   Outside the function, create a variable called `oddChecker` and set it equal to 
//   your function invoked, making sure to pass in an argument.
// */
// let thatsOdd = (number) => {
//   if (number %2 ===0) {
